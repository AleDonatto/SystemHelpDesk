<?php
    ...
    $query = "UPDATE id5812118_system_help_desk.solicitudes SET Estado_solicitud = 'Realizada' WHERE numero_solicitud = $number;";
    ...
    if($estado == "Realizada"){
        ...
        $alert1 = '<script type="text/javascript">
                    alert("La solicitud a sido realizada anteriormente");
